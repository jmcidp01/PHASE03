...
document.addEventListener("DOMContentLoaded", () => {
  ...
  habitualCheckbox = document.getElementById("habitual");
  categoriaSelect = document.getElementById("categoria");
  generoRadios = document.getElementsByName("genero");
  ...
  btnAnadir.addEventListener("click", agregarCliente);
  btnListar.addEventListener("click", listarClientes);
  btnFinalizar.addEventListener("click", finalizar);
  btnEliminar.addEventListener("click", eliminarCliente);
  btnBorrar.addEventListener("click", borrarDatos);
  document.getElementById("pararReloj").addEventListener("click", alternarReloj);
  cargarDatos();
...
function capturarDatos() {
  ...
  const habitual = habitualCheckbox.checked;
...
function eliminarCliente() {
  ...
  const nombreEliminar = prompt("Introduce el nombre del cliente que quieres eliminar:");
